...
dMyDepTrainData := MecanixLT.Liquidos.modConvertData.dMyDepTrainDataNF;
dMyDepTestData  := MecanixLT.Liquidos.modConvertData.dMyIndTestDataNF;
dMyIndTrainData := MecanixLT.Liquidos.modConvertData.dMyIndTrainDataNF;
dMyIndTestData  := MecanixLT.Liquidos.modConvertData.dMyIndTestDataNF;
